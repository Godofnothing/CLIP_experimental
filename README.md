...
This repository contains experiments and results of comparison of image features extractors generated by classical training on ImageNet and CLIP[[paper](https://arxiv.org/abs/2103.00020)][[repo](https://github.com/openai/CLIP)][[blog](https://openai.com/blog/clip/)] training procedure on a specific [Fruits](https://www.kaggle.com/moltean/fruits) dataset.

### **Zero-shot prediсtions**
The procedure described in the CLIP [paper](https://arxiv.org/abs/2103.00020) allows to make predictions on a new image dataset with any set of labels without training. Example of zero-shot predictions on [Sports](https://www.kaggle.com/gpiosenka/sports-classification) dataset.
