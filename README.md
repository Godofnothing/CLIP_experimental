...
The procedure described in the CLIP [paper](https://arxiv.org/abs/2103.00020) allows to make predictions on a new image dataset with any set of labels without training. Example of zero-shot predictions on [Simpsons](link) dataset.
...
We tested zero-shot prediction performance of CLIP on a number of domain-specific datasets. These are [Birds](link), [Simpsons](link), [Sports](link), [Fruits](link). Here are some examples of the predictions:
#### **Sports**
